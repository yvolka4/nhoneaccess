...
<head>
    ...
    <title>One Access Yayasan Nur Hidayah - Login</title>
...
<div class="page">
    ...
    <div class="left">
        ...
        <div class="left-inner">
            ...
            <div class="l-hero">
                <h1>Portal Terpadu<br><span>Yayasan Nur Hidayah</span></h1>
                <p>
    ...
    <div class="right">
        <div class="form-container">
            ...
            @else
                <p class="form-title">Halo, {{ auth()->user()->name ?? 'Pengguna' }}</p>
                <p class="form-sub">Anda sudah masuk ke dalam sistem NH One Access. Silakan lanjutkan ke portal.</p>

                <div style="margin-top: 32px; display: flex; flex-direction: column; gap: 12px;">
                    <a href="{{ route('portal') }}" class="btn-submit" style="text-decoration: none;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
                        Lanjut ke Portal
                    </a>
                    
                    <form method="POST" action="{{ route('logout') }}" style="margin:0;">
                        @csrf
                        <button type="submit" style="width: 100%; padding: 14px; background: transparent; border: 1px solid #cbd5e1; border-radius: 12px; color: #64748b; font-size: 13.5px; font-weight: 600; cursor: pointer; transition: all .2s; display: flex; align-items: center; justify-content: center; gap: 8px;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9"/></svg>
                            Ganti Akun (Keluar)
                        </button>
                    </form>
                </div>
