    ...
    public function up(): void
    {
        $clients = [
            [
                ...
                'redirect_uris' => '["http://nhsolo.com/sikap/sso/callback_oauth2.php","http://localhost/sikap/sso/callback.php"]',
            ...
            [
                ...
                'redirect_uris' => '["http://nhsolo.com/sim/sso/callback_oauth2.php","http://localhost/sim/sso/callback.php","http://localhost/sim/sso/callback_oauth2.php","http://puskomnh.com/sim/sso/callback_oauth2.php","https://puskomnh.com/sim/sso/callback_oauth2.php"]',
                'grant_types' => '["authorization_code","refresh_token"]',
                'revoked' => 0,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'redirect_uris' => '["http://nhsolo.com/sipangkat/sso/callback_oauth2.php","http://localhost/sipangkat/sso/callback.php"]',
                'grant_types' => '["authorization_code","refresh_token"]',
                'revoked' => 0,
                'created_at' => now(),
                'updated_at' => now(),
